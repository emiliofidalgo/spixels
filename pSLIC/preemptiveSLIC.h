...
public:
    ...
    void preemptiveSLIC(const cv::Mat& I_rgb, const int k, const double compactness, int*& klabels, cv::Mat& seeds, vector<double>& clsx, vector<double>& clsy, vector<double>& clsl, vector<double>& clsa, vector<double>& clsb, cv::Mat& I_lab);
